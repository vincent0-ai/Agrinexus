                ...
                return (
                  <div
                    ...
                    className={cn("rounded-2xl border p-5",
                      a.level === "warning" ? "border-amber-200 bg-amber-50" : "border-emerald-200 bg-emerald-50"
                    )}
                  >
                    <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center mb-4",
                      a.level === "warning" ? "bg-amber-100" : "bg-emerald-100"
                    )}>
                      <Icon className={cn("w-5 h-5", a.level === "warning" ? "text-amber-600" : "text-emerald-600")} />
                    </div>
                    <h3 className={cn("font-bold mb-2 text-sm",
                      a.level === "warning" ? "text-amber-800" : "text-emerald-800"
                    )} style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      {a.title}
                    </h3>
                    <p className={cn("text-xs leading-relaxed",
                      a.level === "warning" ? "text-amber-700" : "text-emerald-700"
                    )}>
                      {a.desc}
                    </p>
                  </div>
